# When Do Red and Blue Go Green? — Main Paper Tables and Narrative (v3.1)
...
| **2. Bond Financing** | Whether to finance via debt rather than current revenue | Material (effluent violations, fiscal capacity) | No | Table 2 |
...
| Effluent violations drive issuance | +0.006\*\*\* (Table 2 self-green); +0.003\*\* (Table 1 water); +0.003\*\* (Table 1 non-water) | Steps 1, 2, 3 | Confirmed (\*\*\*) |
| Constituency drives issuance | pres\_dem +0.051\*\* (Table 2 self-green) | Step 2 | Consistent (\*\*) |
| **Constituency × partisan interaction (responsive representation)** | +0.114\*\* (Table 2 self-green); **+0.095\*\*\* (Table 1 NW2)**; +0.001 ns (Table 1 W2 placebo). VIF 1.18 centered. LOSO 0/49 above p = 0.10 | **Step 1, discretionary subdomain only** | Novel, doubly conditional (\*\*) |
